...
PACKAGECONFIG[nss] = "--enable-nss,--disable-nss,nss nspr"
...
RRECOMMENDS_${PN} = "${PN}-data libpurple-plugin-ssl-gnutls libpurple-plugin-ssl-nss libpurple-protocol-irc libpurple-protocol-xmpp"
